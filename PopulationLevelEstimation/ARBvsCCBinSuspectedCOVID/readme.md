...
2. In `R`, use the following `devtools` command to install the ARBvsCCBinSuspectedCOVID package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(ARBvsCCBinSuspectedCOVID)
	...
	outputFolder <- "c:/ARBvsCCBinSuspectedCOVID"
...
License
=======
The ARBvsCCBinSuspectedCOVID package is licensed under Apache License 2.0

Development
===========
ARBvsCCBinSuspectedCOVID was developed in ATLAS and R Studio.
