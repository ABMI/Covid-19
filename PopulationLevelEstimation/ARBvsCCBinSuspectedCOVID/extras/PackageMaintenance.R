...
OhdsiRTools::checkUsagePackage("ARBvsCCBinSuspectedCOVID")
OhdsiRTools::updateCopyrightYearFolder()
devtools::spell_check()

# Create manual -----------------------------------------------------------
shell("rm extras/ARBvsCCBinSuspectedCOVID.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ARBvsCCBinSuspectedCOVID.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "ARBvsCCBinSuspectedCOVID")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ARBvsCCBinSuspectedCOVID")
